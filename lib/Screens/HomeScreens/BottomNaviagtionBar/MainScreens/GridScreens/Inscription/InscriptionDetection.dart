...
import 'package:archeoassist/Screens/HomeScreens/BottomNaviagtionBar/MainScreens/GridScreens/Inscription/ResultPgae.dart';
...
class InscriptionDetection extends StatefulWidget {
  const InscriptionDetection({Key? key}) : super(key: key);

  @override
  State<InscriptionDetection> createState() => _InscriptionDetectionState();
}

class _InscriptionDetectionState extends State<InscriptionDetection> {
  File? _selectedImage;
        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TitleSection('Inscription Detection', size.height * 0.066),
                SizedBox(height: 30),
                Padding(
